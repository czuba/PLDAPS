function [p] = doExperimentTemplate(subj, stimMode, viewdist)
% function [p] = yourPackage.doExperimentTemplate(subj, stimMode, viewdist)
% 
% Template for modular PLDAPS experimental design
% - based on stripped down version of modularDemo.doRfPos_gabGrid
...
pss.mouse.calibration_matrix = eye(3);
